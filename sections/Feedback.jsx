  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="font-bold sm:text-[32px] text-[26px] sm:leading-[40px] leading-[36px] text-white">Donna</h4>
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white" >Founder | CoderVerse</p>
        </div>
      ...
      <motion.div
        ...
        className="lg:block hidden absolute left-[28%] top-[20%]"
      >
        <img 
          src="/stamp.png"
          alt="stamp"
